...
export const metadata: Metadata = {
  title: "Dashboard",
  description: "Manage your NexusGen projects and generations",
};
      ...
      <div className="space-y-4">
        ...
        <div className="flex flex-col items-center justify-center rounded-lg border border-dashed border-border bg-muted/30 py-16">
          ...
          <p className="mb-6 max-w-sm text-center text-sm text-muted-foreground">
            Get started by creating your first AI-generated web application.
          </p>
          <Link
            href="/dashboard/generate"
            className="inline-flex h-10 items-center justify-center gap-2 rounded-md bg-primary px-4 text-sm font-medium text-primary-foreground shadow transition-colors hover:bg-primary/90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
      ...
      <div className="space-y-4">
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <QuickActionCard
            ...
            description="Import from GitHub or upload files"
